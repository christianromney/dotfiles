...
Org Roam (which stays the work knowledge graph). Notes live in per-repo =memos/= silos
(personal + work) as Markdown + YAML front matter — legible to Obsidian and AI tools alike. "Types" are just
