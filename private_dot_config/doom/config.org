...
First, one would need to disable [[https://developer.apple.com/documentation/security/disabling_and_enabling_system_integrity_protection/][System Integrity Protection]].
Then, one could use a utility like the [[https://github.com/DocSystem/tccutil][tccutil]] to modify the
[[https://www.rainforestqa.com/blog/macos-tcc-db-deep-dive][Apple TCC database]] directly.
