...
(setq org-directory          +work-org-dir
      ...
      +papers-notes-dir      (expand-file-name "academic-papers-notes" +info-dir)
...
** Denote
Markdown note-taking with [[https://protesilaos.com/emacs/denote][Denote]], a parallel lane to
Org Roam (which stays the work knowledge graph). Notes live in the personal =memos/= silo as
Markdown + YAML front matter — legible to Obsidian and AI tools alike. "Types" are just
keywords (=journal=, =paper=, =reference=…); silos keep work and personal collections
separate; =denote-markdown= converts =denote:= links to/from portable Markdown links on demand.
...
(after! denote
  (setq denote-directory (expand-file-name "memos" +info-dir)  ; personal silo (default)
        ...
        denote-known-keywords '("data-structures" "math" "distributed-systems" "databases"
...
;; Only the personal silo is active while trialing; add the work memos/ dir here later.
(after! denote-silo
  (setq denote-silo-directories (list (expand-file-name "memos" +info-dir))))

;; Programmatic dir-locals (no committed .dir-locals.el): personal repo => its memos/.
;; Same as the global default today; becomes load-bearing once a work silo is added.
(dir-locals-set-class-variables 'denote-personal-silo
  `((nil . ((denote-directory . ,(expand-file-name "memos" +info-dir))))))
...
** Markdown
GitHub-flavored Markdown; the =+grip= flag adds live preview on =C-c l p=. Lint on open and
save rather than while typing — the live =flycheck= squiggles are jarring.
